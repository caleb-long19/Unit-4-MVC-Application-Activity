...
namespace Unit_4_MVC_Activity.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(COMP2001_CLONGContext context)
        {
            _context = context;
        }
        ...
        {
            var cOMP2001_CLONGContext = _context.Orders.Include(o => o.Customer);
            return View(await cOMP2001_CLONGContext.ToListAsync());
        }
